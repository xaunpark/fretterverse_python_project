...
def run_site_script(site_name):
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            # Always log stdout for successful runs during debugging
            if stdout: # Only log if there is stdout
            ...
            if stdout: # Also log stdout on error, if any
            ...
            try:
                ...
                if last_run_time is None:
                    ...
                    if now_utc >= next_run_time:
                        ...
                        logger.info(f"Site {site_name} is not due yet. Next run at {next_run_time.isoformat()}")
