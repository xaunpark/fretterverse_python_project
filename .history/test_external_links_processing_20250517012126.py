...
def mock_openai_for_ext_links(*args, **kwargs):
    # args[0]=prompt_messages, args[1]=model_name, args[2]=api_key, args[3]=openrouter_base_url, args[4]=user_agent
    ...
    logger.debug(f"Mock OpenAI (ExtLink) called. BaseURL: {args[3]}, JSON: {is_json}. Prompt starts with: {prompt_content[:150]}")
