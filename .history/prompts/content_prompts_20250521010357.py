...
2.  **Editorial Review:**
    ...
    *   Avoid "Walls of Text":** Break down long paragraphs into shorter, focused ones (e.g., 2-5 sentences per paragraph, depending on complexity). Each paragraph should ideally cover a single main idea. Vary paragraph length for better visual appeal and readability.
...
4.  **Adapt Anchor Text:** 
    You have the flexibility to CAREFULLY rephrase the **anchor text** (the visible text within the `<a>...</a>` tags) if your content enhancements make the original anchor text awkward, grammatically incorrect, or less contextually relevant.
    *   **Anchor Text Adaptation - Examples:**
        *   Original HTML: `<p>The company, as detailed in their <a href="http://example.com/report">2023 annual financial report</a>, showed significant growth.</p>`
        *   If you rewrite the sentence to be: `<p>Significant growth was reported by the company last year. For more details, you can consult their official documents.</p>`
        *   **GOOD Adaptation:** `<p>Significant growth was reported by the company last year. For more details, you can consult their <a href="http://example.com/report">official 2023 financial report</a>.</p>` (Anchor text changed to fit new sentence, URL preserved)
        *   **BAD (Avoid):** `<p>Significant growth was reported by the company last year. For more details, you can consult their [SOME NEW LINK].</p>` (URL changed or link removed)
        *   **BAD (Avoid):** `<p>Significant growth was reported by the company last year. For more details, you can consult their 2023 annual financial report.</p>` (Link tag removed entirely)
    *   **Relevance:** Any new anchor text MUST remain highly relevant to the original link's destination (`href`).
    *   **Placement:** Strive to keep the (potentially re-anchored) link as close as possible to its original contextual placement or integrate it naturally into the newly refined text nearby.
    *   Ensure the `<a>` tag structure itself is always valid HTML after any anchor text modification.
