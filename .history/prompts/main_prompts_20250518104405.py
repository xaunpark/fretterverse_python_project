...
I am organizing a database of articles and need to efficiently categorize them based on keywords and search intents. 
Below is a list of existing categories and sub-categories. 
Please analyze each provided keyword and its search intent, then recommend the most appropriate and specific category or sub-category for it. 
...
{{ $('categoryList').item.json["categoryList"] }}

For Each Keyword:

Keyword: "{{ $('Phan tich Keyword').first(0).json["Keyword"] }}"
Search Intent: "{{ $('Phan tich Keyword').first(0).json["parsedContent"]["searchIntent"] }}"
