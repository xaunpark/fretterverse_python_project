...
1.  **CRITICAL - Enhance and Deepen Content (Primary Focus):**
    *   **Integrate Specifics:** For every section, actively seek opportunities to incorporate specific, verifiable data, statistics, research-backed examples, illustrative quotes from credible sources, or relevant case studies that substantiate claims and arguments. If specific data is not available to you, you can suggest areas where such data would be beneficial using a placeholder like `[INSERT SPECIFIC STATISTIC/EXAMPLE ABOUT X HERE]`.
