...
def _determine_category_id(article_meta, keyword_analysis_data, config, wp_auth): # SỬA: Thêm article_meta
    ...
    prompt = main_prompts.RECOMMEND_CATEGORY_PROMPT.format(
        ...
        keyword=original_keyword_for_cat,
...
def finalize_and_publish_article_step(
    ...
    category_id_for_post = _determine_category_id(article_meta, keyword_analysis, preparation_data, config, wp_auth, gsheet_handler)
