...
def call_openai_chat(prompt_messages, model_name, api_key, is_json_output=False, max_retries=3, retry_delay=5):
    """
...
def create_wp_post(base_url, auth_user, auth_pass, title, content, slug, status, categories_ids, author_id, excerpt, featured_media_id=None):
