...
def load_app_config():
    ...
    config['MAX_KEYWORDS_PER_RUN'] = int(os.getenv('MAX_KEYWORDS_PER_RUN', 1)) # Chuyển sang int
    config['DELAY_BETWEEN_KEYWORDS_SEC'] = int(os.getenv('DELAY_BETWEEN_KEYWORDS_SEC', 5)) # Chuyển sang int
    # config['GSHEET_KEYWORD_SHEET_NAME_USED_0'] = os.getenv('GSHEET_KEYWORD_SHEET_NAME_USED_0', 'Keyword Used = 0')
    config['GSHEET_STATUS_COLUMN'] = os.getenv('GSHEET_STATUS_COLUMN') # Sẽ là None nếu không có
