...
DEFAULT_OPENAI_CHAT_MODEL = "deepseek/deepseek-chat-v3-0324" #"openai/gpt-4o-mini" # Model mặc định cho OpenRouter (ví dụ)
DEFAULT_OPENAI_CHAT_MODEL_FOR_OUTLINE = "deepseek/deepseek-chat-v3-0324" #"openai/gpt-4o-mini" # Model cho outline qua OpenRouter
DEFAULT_OPENAI_CHAT_MODEL_FOR_CONTENT = "deepseek/deepseek-chat-v3-0324" #"openai/gpt-4o-mini" # Model cho viết content qua OpenRouter (có thể khác)
