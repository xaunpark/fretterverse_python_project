...
MAX_KEYWORDS_PER_RUN = 20  #  giới hạn số lần thử xử lý các keyword bị lỗi
DELAY_BETWEEN_KEYWORDS_SEC = 5 # Thời gian nghỉ (giây) giữa các keyword
GSHEET_STATUS_COLUMN = "Status" # Tên cột tùy chọn để ghi trạng thái lỗi

ENABLE_FEATURED_IMAGE_GENERATION = False

# --- Cấu hình cho WordPress ---
WP_BASE_URL_PLACEHOLDER = "https://fretterverse.com" # Sẽ được override bởi .env
DEFAULT_POST_STATUS = "publish" # Hoặc 'draft', 'pending'
DEFAULT_AUTHOR_ID = 9 # ID của tác giả mặc định nếu không tìm thấy
...
TOP_RATED_OVERVIEW_LENGTH = 120 # Độ dài mong muốn cho chương tổng quan "Top Rated" (Type 1)
...
IMAGE_SEARCH_MIN_HEIGHT = 300 # Kích thước chiều cao tối thiểu cho ảnh từ Serper
