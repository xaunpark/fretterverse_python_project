...
MAX_KEYWORDS_PER_RUN = 3 # xử lý tối đa 3 keyword mỗi lần chạy script
DELAY_BETWEEN_KEYWORDS_SEC = 5 # nghỉ 5 giây giữa các keyword
# GSHEET_DELETE_SHEET_NAME = "Delete" # Cho script xóa (nếu chưa có)
GSHEET_STATUS_COLUMN = "Status" # Tên cột để ghi lỗi (nếu bạn muốn dùng)
