...
GOOGLE_CX_ID_FOR_SERP_ANALYSIS = "YOUR_CX_ID_FOR_WEB_SEARCH_HERE" # ID của Custom Search Engine (CX) cho Google # Override bởi .env
GOOGLE_CX_ID_EXTERNAL_LINKS = "YOUR_CX_ID_FOR_EXTERNAL_LINKS_SEARCH"
