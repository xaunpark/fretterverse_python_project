...
def mock_openai_chat_responses(prompt_messages_list, model_name_arg, api_key_arg, 
                               openrouter_base_url_arg, user_agent_arg, # Thêm các tham số mới
    ...
    logger.debug(f"Mock OpenAI Chat called. Model: {model_name_arg}, BaseURL: {openrouter_base_url_arg}, JSON output: {is_json_output}. Prompt starts with: {prompt_content[:150]}")
